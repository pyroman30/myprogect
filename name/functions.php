...
function name_scripts() {
	...
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/vendor/bootstrap/css/modern-business.css');

    wp_enqueue_style( 'bootstrap-style', get_template_directory_uri() . '/vendor/bootstrap/css/bootstrap.min.css');

    wp_enqueue_style( 'style_fancybox', get_template_directory_uri() . '/vendor/bootstrap/css/jquery.fancybox.min.css');

    wp_enqueue_style( 'animate', get_template_directory_uri() . '/vendor/bootstrap/css/animate.css');
    ...
    wp_enqueue_script( 'jquery.min', get_template_directory_uri() . '/vendor/jquery/jquery.min.js', array(), fasle, true );

    wp_enqueue_script( 'bundle.min', get_template_directory_uri() . '/vendor/bootstrap/js/bootstrap.bundle.min.js', array(), fasle, true );

    wp_enqueue_script( 'wow.min', get_template_directory_uri() . '/vendor/bootstrap/js/wow.min.js', array('jquery'), fasle, true );
   ...
   wp_enqueue_script( 'popper.js', 'https://unpkg.com/popper.js/dist/umd/popper.min.js', array(), fasle, true );

   wp_enqueue_script( 'fancybox.min', get_template_directory_uri() . '/vendor/bootstrap/js/jquery.fancybox.min.js', array(), fasle, true );
...
add_action('wp_enqueue_scripts', 'name_wow_init_in_footer');
function name_wow_init_in_footer() {
...
add_action( 'wp_enqueue_scripts', 'name_load_fa' );
function name_load_fa() {
